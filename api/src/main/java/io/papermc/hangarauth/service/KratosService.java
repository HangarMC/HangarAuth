...
public class KratosService {
    ...
    public @NotNull SelfServiceSettingsFlow getSettingsFlow(@NotNull String flowId, @NotNull String sessionToken) throws IOException {
        try {
            ...
            final ResponseEntity<String> stringResponseEntity = this.restTemplate.exchange(this.kratosConfig.getAdminUrl() + "/self-service/settings/flows/?id={flow_id}", HttpMethod.GET, new HttpEntity<>(headers), String.class, Map.of("flow_id", flowId));
