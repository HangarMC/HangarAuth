...
public class AvatarTable extends Table {
    ...
    @JdbiConstructor
    public AvatarTable(final OffsetDateTime createdAt, final String type, final String subject, final String optimizedHash, final String unoptimizedHash, final int version) {
        super(createdAt);
        this.type = type;
